...
#We now select the Global Active Power variable and remove NA values, and plot it as a linegraph 
#to 'plot2.png'
...
png("plot2.png")
plot(x = GlobalActivePower$Date, y = GlobalActivePower$Global_active_power, type = "l", ylab = "Global Active Power (kilowatts)", xlab = "")
dev.off()
